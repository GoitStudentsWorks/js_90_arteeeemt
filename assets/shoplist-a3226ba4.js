import"./support-6903325c.js";const e=document.querySelector(".js-shoping-list-book"),n=document.querySelector(".listOfBookFromCategory");let s=JSON.parse(localStorage.getItem("books"));i();e.addEventListener("click",r);function i(){if(!s||s.length===0){const t=p();n.innerHTML=t,e.style.display="none";return}e.style.display="flex",e.innerHTML=l(s)}function r(t){if(t.target.tagName!="BUTTON")return;const o=s.findIndex(a=>a._id===t.target.dataset.id);s.splice(o,1),localStorage.setItem("books",JSON.stringify(s)),i()}function p(){return` <div class="shoping-empty">
